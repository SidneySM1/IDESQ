...
<body>
    <div class="container mt-5">
        <form action="saveEditProfile.php" method="POST" enctype="multipart/form-data">

            <fieldset>
            <legend><b>Edite seu perfil</b></legend>
        ...
        <p class="text-center">Usuario <?php echo $user_type2; ?></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="<?php echo $name;?>" required readonly>
                </div>
                <div class="form-group">
    ...
    <input type="username" name="username" id="username" class="form-control" value="<?php echo $username;?>" required readonly>
</div>
                <div class="form-group">
    ...
    if ($user_type2 === 'aluno') {
        ...
        if ($resultTurmasUsuario && $resultTurmasUsuario->num_rows > 0) {
            while ($turma = $resultTurmasUsuario->fetch_assoc()) {
                ...
                echo "<label class='form-check-label btn-add-turma'>$turmaNome</label>";
