...
if ($user_type === 'professor' || $user_type === 'admin') {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Prepare a instrução SQL para inserção dos dados
        $sql = "INSERT INTO atividades (turma_id, titulo, descricao, data_entrega) VALUES ('$turma', '$titulo', '$descricao', '$dataEntrega')";
    
        // Execute a consulta SQL
        if (mysqli_query($mysqli, $sql)) {
            // Inserção bem-sucedida, redirecione para a página de visualização de atividades
            header("Location: atividade_create.php");
            exit;
        } else {
            // Erro ao executar a consulta SQL
            echo "Erro ao inserir a atividade: " . mysqli_error($mysqli);
        }
    }
  }
   // Obter as turmas disponíveis para atribuição
   $sql = "SELECT nome FROM turmas";
   // Executar a query SQL e obter os resultados
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <?php if ($user_type === 'professor' || $user_type === 'admin'): ?>
